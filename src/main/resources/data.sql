...
INSERT INTO Auction (DESCRIPTION, END_DATE_TIME, FINISHED, KEY_WORDS, PICTURE_ADDRESS, RESERVATION_PRICE, START_PRICE,
                     TITLE, INVOICE_ID, USER_ID)
VALUES ('Blå med ett hål för huvudet', '2021-08-30 10:11:12', 0, 'kläder', '74827b6a-92b6-4a13-8a62-9491e4db68d1.jpg', 150, 50, 'Blå tröja',
        null, 1);

INSERT INTO Auction (DESCRIPTION, END_DATE_TIME, FINISHED, KEY_WORDS, PICTURE_ADDRESS, RESERVATION_PRICE, START_PRICE,
                     TITLE, INVOICE_ID, USER_ID)
VALUES ('Röd med ett hål för huvudet', '2021-08-30 10:11:12', 0, 'kläder', '74827b6a-92b6-4a13-8a62-9491e4db68d1.jpg', 150, 50, 'Röd tröja',
        null, 1);
